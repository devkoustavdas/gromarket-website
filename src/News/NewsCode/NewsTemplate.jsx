        ...
        <main className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-3/5 shadow-lg m-3 rounded-lg px-3 md:px-5 py-2 pb-4">
                <Meta
                    ...
                    type="article"
                />
                <Heading title={title} description={description} date={date} tags={tags} />
                <div className="lg:flex flex-row">
                    <section>
                        <div className="font-title text-sm w-11/12 leading-loose">
                            <span
                                className="hover:bg-slate-700 px-2 py-1 rounded duration-200"
                                title="Go to GroMarket Home Page"
                            >
                            ...
                            <span className="text-teal-500">/</span>
                            <span className="bg-slate-800 px-2 py-1 rounded hover:bg-slate-700 duration-200">
                                <Link to={`/news/${link}`} className="no-underline">
                                    {title}
                                </Link>
                            </span>
                        </div>
            ...
            <React.Suspense fallback={<div>Loading...</div>}>
                <div className="w-19/20 mx-auto lg:w-2/5">
                    <div className="text-xl font-sans text-center mt-5 mb-3 font-bold text-teal-500">
                        Read More News
                    </div>
                    <NewsList type="part" />
                </div>
