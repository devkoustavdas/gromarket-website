    ...
    return (
        <main className="mt-24">
            ...
            <div className="w-fit mx-auto">
                ...
                <p>
                    <b>Error Status:</b> <i><Btn icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
                    ...
                    </svg>} type="DANGER" title="Error Message" text={error.statusText || error.message} /></i>
                </p>
            </div>
        </main>
    );
