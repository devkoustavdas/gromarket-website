    ...
    <footer className=" bg-slate-800 py-2 px-3 min-h-fit">
      ...
      <div className="sm:flex sm:items-center sm:justify-around mt-5">
        ...
        <div className="flex gap-2 mt-4 sm:justify-center sm:mt-0">
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/gromarket.official/" className="text-slate-500 hover:text-slate-300">
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/gromarket_" className="text-slate-500 hover:text-slate-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
              <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" />
            </svg>
            <span className="sr-only">GroMarket Twitter page</span>
          </a>
          <a target="_blank" rel="noopener noreferrer" href="https://www.threads.net/@gromarket.official" className="text-slate-500 hover:text-slate-300">
            ...
            <span className="sr-only">GroMarket Threads page</span>
          </a>
        </div>
      </div>
    </footer>
