    ...
    <footer className=" bg-slate-800 py-2 px-3 min-h-fit">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2 mt-4 sm:justify-center sm:mt-0">
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/gromarket.official?igsh=MXQ1MGQ3cnVrNWt3aQ==" className="text-slate-500 hover:text-slate-300">
